      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.subTitle}>
            Composer{`\n`}Bibilandeniye Mahanama
          </Text>

          <Text style={styles.description} numberOfLines={4}>
            Immerse yourself in celestial harmonies that open space in your mind
            and guide you into deep relaxation. Let the cosmic atmosphere carry
            you into serenity.
          </Text>
